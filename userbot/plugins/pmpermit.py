...
if PMPERMIT_PIC is None:
  WARN_PIC = "http://cvatricks.xp3.biz/images/download.png"
else:
...
USER_BOT_WARN_ZERO = " "
USER_BOT_NO_WARN = ("**Hello !** __💬 Messaging is not yet Authorised by you.\n"
                    "`😏 Cool, still there is a way to get Authorisation for Message`\n\n"
                    "**Currently **\n"
                    f"{DEFAULTUSER} is Offline or may be Busy ! So Better Don't Spam His Inbox !\n\n"
                    f"{CUSTOM_MIDDLE_PMP} \n\n"
                    "**Now You Are In Trouble So Send** 🍁 `/start` 🍁  **To Authorise, 💬 Messages!!**")
